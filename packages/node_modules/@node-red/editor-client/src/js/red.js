...
var RED = (function() {
    ...
    function buildMainMenu() {
        ...
        menuOptions.push({id:"menu-item-view-menu",label:RED._("menu.label.view.view"),options:[
            {id:"menu-item-left-sidebar",label:RED._("menu.label.sidebar.showLeft"),toggle:true,onselect:"core:toggle-left-sidebar", selected: true},
            {id:"menu-item-right-sidebar",label:RED._("menu.label.sidebar.show"),toggle:true,onselect:"core:toggle-right-sidebar", selected: true},
        ...
        if (RED.settings.theme("menu.menu-item-keyboard-shortcuts", true)) {
            menuOptions.push({id: "menu-item-keyboard-shortcuts", label: RED._("menu.label.keyboardShortcuts"), onselect: "core:show-keyboard-settings"});
        }
